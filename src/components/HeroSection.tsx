        ...
        <div className="grid gap-8 lg:grid-cols-2 items-center">
          ...
          <div className="space-y-8 text-left animate-fade-in">
            ...
            <p className="text-xl text-muted-foreground max-w-xl animate-fade-in animation-delay-300">
              GPUverse connects compute providers with AI developers for secure, blockchain-based rentals.
            </p>
            ...
            <div className="pt-4 flex items-center gap-2 text-sm text-muted-foreground animate-fade-in animation-delay-700">
              ...
              <span>
                Join <span className="text-foreground font-medium">500+</span>{" "}
          ...
          <div className="relative order-first lg:order-last animate-fade-in animation-delay-300 aspect-square max-w-[500px] mx-auto bg-card/30 rounded-3xl backdrop-blur-sm p-6 border border-muted shadow-2xl hover:shadow-marketplace-primary/20 hover:border-marketplace-primary/30 transition-all duration-500">
            {/* Spline Animation Fit */}
